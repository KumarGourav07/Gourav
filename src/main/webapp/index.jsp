...
<head>
    ...
    <title>HI BHOPAL</title>
    <link rel="stylesheet" href="index.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css"> <!--for fab icons-->
</head>
<body>
  <input type="hidden" id="status" value="<%= request.getAttribute("status") %>" >
    <header class="header">
        <a  class="brand">HI BHOPAL</a>
        ...
        <div class="navigation">
                ...
                <%
                 ...
                 %>
                <form ><button type="button" class="login">Login</button></form>
                <%
                } else {
                %> 
                <form action="logout" method="post"><button type="submit" class="logout"><%= session.getAttribute("savedusername") %></button></form>
                <%
                  }
                %>          
        </div>
    ...
    <main>
        <section class="home">
            <video class="video-slide active" src="videos/food.mp4" autoplay muted loop></video>
            <video class="video-slide" src="videos/stay.mp4" autoplay muted loop></video>
            <video class="video-slide" src="videos/travel.mp4" autoplay muted loop></video>

            <div class="content active">
                <h1 class="foodTitle">FOOD CORNERS<br><span>Pocket friendly</span></h1>
                <p class="foodContent"><pre>Feeling hungry? Searching for reasonably priced and high-quality food shops? Look no further! 
Team HI BHOPAL is here to make your culinary journey more convenient and enjoyable. 
We're here to help you find the best food options and ensure you have a delightful dining experience. </pre></p>
            ...
            <div class="content">
              <h1 class="foodTitle">STAYING PLACES<br><span>Home like vibe</span></h1>
              <p class="foodContent"><pre>New in Bhopal and looking for accommodation near your college? 
...
essential amenities such as markets, stationary shops, and more.</pre></p>
            ...
            <div class="content">
               <h1 class="foodTitle">VIEW POINTS<br><span>Close to Nature</span></h1>
               <p class="foodContent"><pre>Excited to explore the beauty of Bhopal? Team HI BHOPAL is your perfect guide to discover 
...
appreciate the city's wonders, ensuring your journey is filled with memorable moments</pre></p>
                        ...
                        <form action="registration" method="post">
                           <div class="input-box">
                            ...
                            <div class="input-box">
                             ...
                             <div class="login-registration">
                                 <p>Aready have an account?<a href="#" class="login-link" >Login</a></p>
                             </div>
